...
import T3 from '../assets/push-up.JPG'
    ...
    return(
      <section className="section">
        <div className="home-body">
          ...
          <br/>
          <p className="quote">Do you slave away in the gym but still get no results? </p>
          <br/>
          <p className="quote"> Don’t worry, that was me. I was in the same boat, so can totally relate. </p>
          <br/>
          <p className="quote"> Through diet and exercise alone, I managed to turn my life around for the better.</p>
